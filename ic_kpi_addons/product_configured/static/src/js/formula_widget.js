odoo.define('product_configured.widget_formula_text', function (require){
"use strict";
...
var FormulaDomain = AbstractField.extend({
    /**
...
FieldRegistry.add('formula_domain', FormulaDomain);
});