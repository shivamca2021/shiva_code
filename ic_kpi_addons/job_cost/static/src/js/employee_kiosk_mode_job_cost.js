odoo.define('job_cost.employee_kiosk_mode_job_cost', function (require) {
    "use strict";
    ...
    var JoBKioskMode = AbstractAction.extend({
        events: {
            "click .o_hr_attendance_button_employees": function() {
                this.do_action('job_cost.hr_employee_attendance_action_kanban_mode_job_cost', {
        ...
        start: function () {
            ...
            var def = this._rpc({
                ...
                .then(function (companies){
                    ...
                    self.$el.html(QWeb.render("JobModeHrAttendanceKioskMode", {widget: self}));
                    self.start_clock();
                });
        ...
        _callServer: function () {
            ...
            return ajax.rpc("/job_cost/kiosk_keepalive", {});
        },
    
    });
    
    core.action_registry.add('employee_kiosk_mode_job_cost', JoBKioskMode);
