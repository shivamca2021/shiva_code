odoo.define('job_cost.kiosk_mode', function (require) {
    "use strict";
    ...
    var KioskMode = AbstractAction.extend({
        events: {
            "click .o_job_cost_attendance_button_employees": function() {
                this.do_action('job_cost.job_cost_workcenter_action_kanban', {
        ...
        start: function () {
            ...
            var def = this._rpc({
                ...
                .then(function (companies){
                    ...
                    self.$el.html(QWeb.render("JobAttendanceKioskMode", {widget: self}));
                    self.start_clock();
                });
    ...
    core.action_registry.add('job_cost_kiosk_mode', KioskMode);
