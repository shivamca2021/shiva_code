...
class TestSaleOrderLineDates(TransactionCase):
    def setUp(self):
        ...
        self.sale_line1 = self._create_sale_order_line(self.sale1, product_id, qty, price, dt1)
        self.sale_line2 = self._create_sale_order_line(self.sale1, product_id, qty, price, dt2)
        self.sale_line3 = self._create_sale_order_line(self.sale1, product_id, qty, price, None)
