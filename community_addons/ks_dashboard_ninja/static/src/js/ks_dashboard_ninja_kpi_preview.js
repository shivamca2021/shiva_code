    ...
    var KsKpiPreview = AbstractField.extend({
        ...
        ksSum: function(count_1, count_2, item_info, field, target_1, $kpi_preview, kpi_data) {
            ...
            if (field.ks_multiplier_active){
                item_info['count'] = KsGlobalFunction._onKsGlobalFormatter(count* field.ks_multiplier, field.ks_data_format);
                item_info['count_tooltip'] = field_utils.format.float(count * field.ks_multiplier, Float64Array);
            }else{

                item_info['count'] = KsGlobalFunction._onKsGlobalFormatter(count, field.ks_data_format);
...
//            }
            ...
            if (field.ks_multiplier_active){
                item_info['count_1'] = KsGlobalFunction._onKsGlobalFormatter(kpi_data[0]['record_data'] * field.ks_multiplier, field.ks_data_format);
                item_info['count_1_tooltip'] = kpi_data[0]['record_data'] * field.ks_multiplier
            }else{
                item_info['count_1'] = KsGlobalFunction._onKsGlobalFormatter(kpi_data[0]['record_data'], field.ks_data_format);
            }
            item_info['target'] = KsGlobalFunction._onKsGlobalFormatter(kpi_data[0].target, field.ks_data_format);
                ...
                switch (field.ks_data_comparison) {
                    case "None":
                         if (field.ks_multiplier_active){
                            ...
                            item_info['count'] = String(KsGlobalFunction._onKsGlobalFormatter(count_1 * field.ks_multiplier, field.ks_data_format)) + "/" + String(KsGlobalFunction._onKsGlobalFormatter(count_2 * field.ks_multiplier, field.ks_data_format));
                         }else{
                            ...
                            item_info['count'] = String(KsGlobalFunction._onKsGlobalFormatter(count_1, field.ks_data_format)) + "/" + String(KsGlobalFunction._onKsGlobalFormatter(count_2, field.ks_data_format));
                         }
